            ...
            <div class="col-sm-12">
              <div class="tab-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="jadlogclassic_status" class="form-control">
                            <?php if ($jadlogclassic_status) { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="jadlogclassic_sort_order" class="form-control" value="<?php echo $jadlogclassic_sort_order; ?>" size="3" /> <?php echo $text_sort_order; ?>
                    </div>
                </div>
